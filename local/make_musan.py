...
def prepare_music(root_dir, use_vocals):
    ...
    for utt in utt2vocals:
        if utt in utt2wav:
            ...
            num_bad_files += 1
    print("In music directory, processed", num_good_files, "files;",
          num_bad_files, "had missing wav data")
...
def prepare_speech(root_dir):
    ...
    for utt in utt2spk:
        if utt in utt2wav:
            ...
            print("Missing file", utt)
            num_bad_files += 1
    print("In speech directory, processed", num_good_files, "files;",
          num_bad_files, "had missing wav data")
    return utt2spk_str, utt2wav_str
...
def prepare_noise(root_dir):
    ...
    for utt in utt2spk:
        if utt in utt2wav:
            ...
            print("Missing file", utt)
            num_bad_files += 1
    print("In noise directory, processed", num_good_files, "files;",
          num_bad_files, "had missing wav data")
    return utt2spk_str, utt2wav_str
